...
namespace TweetSharp
{
    ...
    public partial class TwitterService : ITwitterService
    {
        ...
        {
            var name = options.Name;
            var mode = options.Mode == TwitterListMode.Public ? "public" : "private";
            var description = options.Description;


            return WithHammock<TwitterList>(WebMethod.Post, "lists/create", FormatAsString, "&name=", name, "&mode=", mode, "&description=", description);
        }
        ...
        public virtual IAsyncResult ListFriends(ListFriendsOptions options, Action<TwitterCursorList<TwitterUser>, TwitterResponse> action)
        {
            ...
            return WithHammock(action, "friends/list", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&skip_status=", skip_status, "&include_user_entities=", include_user_entities, "&count=", count);
        }
        ...
        public virtual IAsyncResult ListFollowers(ListFollowersOptions options, Action<TwitterCursorList<TwitterUser>, TwitterResponse> action)
        {
            ...
            return WithHammock(action, "followers/list", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&skip_status=", skip_status, "&include_user_entities=", include_user_entities, "&count=", count);
        }
        ...
        public virtual IAsyncResult CreateList(CreateListOptions options, Action<TwitterList, TwitterResponse> action)
        {
            ...
            return WithHammock(WebMethod.Post, action, "lists/create", FormatAsString, "&name=", name, "&mode=", mode, "&description=", description);
        }

        public IAsyncResult UpdateList(UpdateListOptions options, Action<TwitterList, TwitterResponse> action)
        {
            var lid = options.ListId.ToString();
            var name = options.Name;
            var desc = options.Description;
            var tlm = options.Mode == TwitterListMode.Public ? "public" : "private";

            return WithHammock(WebMethod.Post, action, "lists/update", FormatAsString, "&list_id=", lid, "&name=", name, "&description=", desc, "&mode=", tlm);
        }
        ...
        public virtual IAsyncResult BeginCreateList(CreateListOptions options)
        {
            ...
            return BeginWithHammock<TwitterList>(WebMethod.Post, "lists/create", FormatAsString, "&name=", name, "&mode=", mode, "&description=", description);
        }
